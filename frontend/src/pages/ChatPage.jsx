...
function EmptyState() {
  return (
    <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", gap: 12, background: "white" }}>
      <div style={{ fontSize: 52 }}>💬</div>
      <p style={{ color: "blue-600", fontSize: 14, margin: 0 }}>Select a channel to start chatting</p>
