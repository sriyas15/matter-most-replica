...
export default function ChannelSidebar() {
  ...
  const [unreadMap, setUnreadMap]         = useState({});   // channel unread
  ...
  useEffect(() => {
    ...
    const onNew = (msg) => {
      ...
      // Only count for non-DM channels
      ...
      <div style={S.sidebar}>
        ...
        <div style={S.header}>
          <div style={S.workspaceName}>
            ...
            <i className="ti ti-chevron-down" style={{ fontSize: 14, color: "#7070a0" }} />
          </div>
...
const S = {
  ...
  workspaceName: { fontSize: 14, fontWeight: 500, color: "#e8e8f0", display: "flex", alignItems: "center", gap: 6, cursor: "pointer" },
